    ...
    public partial class _1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                name: "CategoriesExpenseAndIncome",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoriesExpenseAndIncome", x => x.Id);
                })
                .Annotation("MySql:CharSet", "utf8mb4");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RolePermissions", x => new { x.PermissionsId, x.RolesRoleId });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeTransaction = table.Column<int>(type: "int", nullable: false),
                    Sum = table.Column<decimal>(type: "decimal(65,30)", nullable: false),
                    FixedExpenseAndIncomeId = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ExpensesAndIncomes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ExpensesAndIncomes_CategoriesExpenseAndIncome_CategoryId",
                        column: x => x.CategoryId,
                        principalTable: "CategoriesExpenseAndIncome",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ExpensesAndIncomes_FixedExpensesAndIncomes_FixedExpenseAndIn~",
                        column: x => x.FixedExpenseAndIncomeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExpensesAndIncomes_CategoryId",
