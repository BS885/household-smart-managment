...
namespace SmartManagement.Data.Migrations
{
    ...
    [Migration("20250528092135_add S3_key2")]
    partial class addS3_key2
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SmartManagement.Core.Models.CategoryExpenseAndIncome", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "קניות בסופר, משנת יוסף",
                            ISExpense = true,
                            IsIncome = false,
                            Name = "אוכל"
                        },
                        ...
                        {
                            Id = 9,
                            Description = "ארנונה, חשמל, מים, גז, ",
                            ISExpense = true,
                            IsIncome = false,
            ...
            modelBuilder.Entity("SmartManagement.Core.Models.PasswordResetToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
